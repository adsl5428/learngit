	...
	while (!rsMain.IsEOF())
	{
		...
		{	
			int ikongjian[]={IDC_STATIC_ID,IDC_EDIT_NAME,IDC_EDIT_TYPE1,IDC_EDIT_MONEY,
				...
				,IDC_EDIT_LIXI,IDC_EDIT_FUWUFEI,IDC_EDIT_BEIZHU,IDC_EDIT_STARTTIME,IDC_EDIT_ENDTIME,IDC_EDIT_JINGBANREN,IDC_EDIT_CHUZIREN,IDC_EDIT_IDCARD,IDC_EDIT_XUHUANKUAN};
